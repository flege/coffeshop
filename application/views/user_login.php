...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?=HTTP_PATH?>plugins/iCheck/square/blue.css">
...
<!-- iCheck -->
<script src="<?=HTTP_PATH?>plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
